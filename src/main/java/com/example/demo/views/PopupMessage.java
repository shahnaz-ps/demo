...
public class PopupMessage {
    ...
    private void setStyleForError(Alert alert) {
        ...
        dialogPane.setStyle("-fx-border-radius: 10; -fx-border-color: #ec0e0e; -fx-border-width: 3; -fx-background-radius: 14; -fx-background-color: #e1751d; -fx-font-family: \"High Tower Text\";");
